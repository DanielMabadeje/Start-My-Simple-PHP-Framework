...
{
    protected $commandName = 'routes:all';
    protected $commandDescription = "Gets All Routes";
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $myfile = fopen("config/routes.php", "r") or die("Unable to open file!");
        echo fread($myfile, filesize("config/routes.php"));
    }
}
